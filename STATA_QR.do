/*
	...
	Author:		Jilly Hebert, Amanda Irish, and Anusha Vable
...
*/
	...
	**Bootstrap 95% CIs
	forval i=0.01(0.01)0.99 {
		...
		c.mom_ed c.dad_ed i.southern i.year, quantile(`i') reps(500)
	...
	**Bootstrap 95% CI's
	forval i=1(1)99 {
		...
		rifhdreg sbp c.schlyrs c.age c.age2 i.gender i.race c.mom_ed ///
		c.dad_ed i.southern i.year, rif(q(`i')) vce(bootstrap, reps(500))
